...
const Footer = () => (
  ...
  >
    <div className="container mx-auto max-w-6xl md:max-w-4xl w-full grid grid-cols-3 max-md:grid-cols-2 gap-4 text-white ">
      <div className="max-md:self-center max-md:justify-self-center">
      ...
      <div className="text-white fill-white text-6xl flex justify-center md:justify-end max-md:col-span-2 md:self-center">
