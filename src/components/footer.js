...
const Footer = () => (
  ...
  >
    <div className="container mx-auto max-w-6xl md:max-w-4xl w-full md:grid md:grid-cols-3 flex flex-wrap gap-4 text-white ">
      ...
      <div className="text-white fill-white text-6xl flex justify-center flex-1 md:justify-end md:self-center">
